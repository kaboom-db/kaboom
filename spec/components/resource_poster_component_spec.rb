...
RSpec.describe ResourcePosterComponent, type: :component do
  context "when resource is a comic" do
    it "renders the resource's poster and name" do
      ...
      expect(page).to have_css "div[class='bg-primary px-2 py-1 text-xs font-bold absolute rounded inline-block bottom-2 right-2']", text: "2018"
  ...
  context "when resource is an issue" do
    it "renders the resource's poster and name" do
      ...
      expect(page).to have_css "div[class='bg-primary px-2 py-1 text-xs font-bold absolute rounded inline-block bottom-2 right-2']", text: "10.1"

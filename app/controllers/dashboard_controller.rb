class DashboardController < ApplicationController
  ...
  def index
    ...
    @chart_data = Charts::UserCountsChart.new(resource: current_user, num_of_elms: 14, type: Charts::ChartCountGenerator::BAR, range_type: Charts::FrequencyChartGenerator::DAY).generate
  end
